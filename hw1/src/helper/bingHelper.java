...
public class bingHelper {
  ...
  public static List<Document>  bingSearch() throws EncoderException, JSONException{
  ...
  public static List<Document> documentsFromResult(String result) throws JSONException{
